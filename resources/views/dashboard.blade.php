...
<html>
  ...
  <body class="m-0 font-sans antialiased font-normal text-base leading-default bg-gray-20 text-slate-500">
    <!-- sidenav  -->
    <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
      <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="javascript:;">
          <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">CinemaTech Dashboard Admin</span>
        </a>
      </div>
...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg border-b">
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400  border-b-gray " >
