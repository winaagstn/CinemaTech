 <div class="w-auto flex flex-none overflow-x-auto   pb-12">
     <div class="flex items-center justify-center h-screen px-20 ">
         @foreach ($topTVShows as $tvShowsItem)
             ...
             <div
                 class="grid rounded-3xl w-[300px]  shadow-sm bg-gradient-to-b from-indigo-800 to [#110426]  flex-row mr-8">
                 <img src="{{ $tvShowsImage }}" width="352" height="300"
                     class="rounded-t-3xl justify-center grid h-80 object-cover" alt="movie.title" />

                 <div class="group p-4 grid z-10">
                     <a href="tvshow/{{ $tvShowsID }}"
