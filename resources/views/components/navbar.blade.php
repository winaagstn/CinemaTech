<nav class=" bg-white dark:bg-gray-900 sticky w-full z-20 top-0 start-0  drop-shadow-lg">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <button type="button"
                class="text-white bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 font-light font-montserrat rounded-full text-lg px-4 py-2 text-center "><a href="/login">Login</a></button>
