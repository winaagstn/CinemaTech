...
@section('contain')
    ...
    <div
        ...
        <div class="md:w-2/3 pr-5">
            ...
            <div class="text-gray-400 text-base leading-6 w-full mt-4 max-md:max-w-full">
                ...
                This movie captivates audiences with stunning visuals and a profound narrative, inviting viewers to explore
    ...
    <div class='w-auto pl-18  pt-6 pb-10 grid grid-cols-3 lg:grid-cols-5 gap-8 ' id='dataWrapper'>
        ...
        @foreach ($movies as $movieItem)
            ...
            <a href='/movie/{{ $movieID }}' class='group'>
                <div class='min-w-[202px] min-h-[400px] bg-gray-900 drop-shadow-[0_0px_8px_rgba(0,0,0,0.25)] group-hover:drop-shadow-[0_0px_8px_rgba(0,0,0,0.5)] rounded-[32px] p-5 flex flex-col duration-100'
    ...
    <div class="flex justify-center mt-8 mb-10">
        @if ($page > 1)
            <!-- Previous Button -->
            <a href="{{ route('movies', ['page' => $page - 1]) }}"
